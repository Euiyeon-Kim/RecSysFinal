"""
Modified from https://raw.githubusercontent.com/zzaebok/KGCN-pytorch/master/data_loader.py
"""
import random
...
class KGDataLoader:
    def __init__(self, data):
        self.cfg = {
            'movie': {
                'item2id_path': 'datasets/movie/item_index2entity_id.txt',
                'kg_path': 'datasets/movie/kg.txt',
                'rating_path': 'datasets/movie/ratings.csv',
                'rating_sep': ',',
                'threshold': 4.0
            },
            # 'music': {
